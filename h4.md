...
Yllä olevan artikkelin mukaa, on mahdollista että jollain olisi samalainen laite mikä hyväksyisi rfid kortilta maksuja, sillä skannataan ihmisen kortti ja otetaan kortin tiedot ylös ja möyhemmin käytetään sitä korttia verkko-maksuja tehtäessään. 

RFID-skannerit eivät voi lukea täydellisiä korttitietoja 2-3m päästä, tämä rfid skimming hyökkäys tapahtuisi silloin kun joku on todella lähellä korttiasi.
...
Sain tekoälyllä generoitu tälläisen hienon diagrammin 
...
│  │  ┌─────────────────────────────────┐  │  │
│  │  │  • Salainen avain               │  │  │
│  │  │  • Kryptogrammin laskenta       │  │  │
│  │  │  • PIN-vertailu                 │  │  │
│  │  └─────────────────────────────────┘  │  │
│  └───────────────────────────────────────┘  │
│                                             │
│  APDU-käsittelijä:                          │
│  "Tuohan kysyy kryptogrammia,               │
│   pyydän secure elementiä laskemaan sen"    │
└─────────────────────────────────────────────┘
