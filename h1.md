...
Päivämäärä: 24/10/2025 18:00-21:20, Päivitys: 24/10/2025  21:30-22:30, Päivitys 25/10/2025 11:30 - 12:30



# x) Lue ja tiivistä. [Artikkeli 1](https://terokarvinen.com/wireshark-getting-started/) , [Artikkeli 2](https://terokarvinen.com/network-interface-linux/)

---Päivitys 25/10/2025 11:30-12:30---

## Artikkeli 1 

- Wiresharkin asentaminen debianille, miten annetaan oikeudet käyttäjäryhmälle capturaa wiresharkista paketteja.

- Miten wiresharkin GUI:tä käytetään: miten paketteja tallennetaan, mitä interfacea pitäisi tallentaa/tutkia ja miten pysäytetään wireshark pakettien tallennus.

- Filtterien käyttäminen wiresharkissa, esim. http filtteri näyttää ainoastaan kaikki http protokollaan kuuluvat paketiti wiresharkissa.

- Wiresharkissa näkyy tilastoja esim. I/O Graphs, tämä tilasto näyttää mitä on milloinkin tapahtunut isommassa skaalassa. 

  Tässä näytönkaappaus teron kotitehtävän I/O graphista. 

<img width="1891" height="887" alt="image" src="https://github.com/user-attachments/assets/a71106df-f3c6-49ea-8dcd-c396ea326d51" />


## Artikkeli 2

- Linuxin network interfacet, on melkein kui fyysinen verkkokortti, mutta siinä on muutama erovaisuus.

- Network interface on yhtä kuin verkkoliittymä, mutta ei välttämättä fyysinen (esim. loopback localhost-yhteyksiä varten).

- Tässä poimittu artikkelistä yleiset verkkoliittymät ja niitten nimet.

<img width="789" height="243" alt="image" src="https://github.com/user-attachments/assets/2c3af7d5-d17e-4bb4-a674-4e4ebbaf7b1c" />

- Etuliitteen jälkeiset numerot tunnistavat laitteen tai sen sijainnin tietokoneessa
...
<img width="839" height="169" alt="image" src="https://github.com/user-attachments/assets/0288e3d2-9a10-47cb-9c66-9b5ae075462d" />


# b) Ei voi kalastaa. Osoita, että pystyt katkaisemaan ja palauttamaan virtuaalikoneen Internet-yhteyden.


Tässä käytin ping komentoa. 
...
QUIC protokolla en ole aikasemmin nähnyt, mutta ilmeisesti tämä on googlen oma kehittämä protokolla mitä nykyään käyttää kaikki selaimet. (Lähde 6)
...
Tämän perusteella sain tietää, että tämä on todennäköisesti julkinen identifoija millä voidaan tunnistaa yhteyden ominaisuutta. 
...
7) https://terokarvinen.com/wireshark-getting-started/
